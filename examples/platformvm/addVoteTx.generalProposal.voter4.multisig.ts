...
const msig_one_owner = "PROPOSAL_ID" // Multisig Address with 1 owner (threshold 1)
...
const main = async (): Promise<any> => {
  ...
  const proposalID = "2CTXWCLH2LLqYMMT3ngpMX7DxGZbaobFwecYZsgp6UFLTGzTh8" // This is an example ID, replace with your actual proposal ID
