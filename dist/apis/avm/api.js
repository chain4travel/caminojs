...
class AVMAPI extends jrpcapi_1.JRPCAPI {
    ...
    constructor(core, baseURL = "/ext/bc/X", blockchainID = "") {
        ...
        this.getBlockByHeight = (height, encoding) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.callMethod("avm.getBlockByHeight", params);
